...
export default function CatalogPage() {
  ...
  const addToWishlist = async (productId) => {
    try {
      ...
      await clienteAxios.post("/wishlist", { productId }, {
  ...
  if (loading) return <div style={{ color: "white", textAlign: "center", marginTop: "50px" }}>Cargando catálogo...</div>;
            ...
            return (
              <div key={productId} style={{ border: "1px solid #444", borderRadius: "8px", padding: "15px", backgroundColor: "#1e1e1e", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                <div>
                  ...
                  <p style={{ fontSize: "12px", color: "#888" }}>Stock: {product.stock}</p>
                </div>
